...
@section('title','Container Loading')
...
<div class="d-flex justify-content-end mb-3 gap-2">
    <button id="btnRotateSelected" class="btn btn-secondary">
        Rotate Selected
    </button>
    <button
        id="btnGenerate"
    ...
    <div class="col-md-3">
        ...
        <div class="box p-3 mt-3">
            <h5>Unplaced Items</h5>
            <p id="unplacedInfo">All items ready for loading.</p>
        </div>
