    ...
    $('#btnAddRow').click(function() {
        ...
        const newRow = `
            <tr>
                ...
                <td><ul style="padding-left:18px; margin:0;" contenteditable="true"><li></li></ul></td>
                <td contenteditable="true"></td>
                <td contenteditable="true"></td>
                <td contenteditable="true"></td>
                <td>
        ...
        // fokus langsung ke kolom Description
        $('table tbody tr:first td:nth-child(2)').focus();

        // perbarui nomor urut semua
        updateRowNumbers();
    });
    ...
    function updateRowNumbers() {
        ...
        $(document).on('click', '.save-btn', function() {
            ...
            const data = {
                ...
                labels: row.find('ul li').map(function() {
