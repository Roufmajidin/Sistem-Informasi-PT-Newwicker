...
<script>
   $.get('/bom-produksi/bom/create-partial', function (html) {
...
$('a[href="#harga"]').one('click', function () {
    ...
    $('#harga').load('/bom-produksi/bom/harga-partial');

});

$('a[href="#finishing"]').one('click', function () {

    $('#finishing').load('/bom-produksi/bom/finishing-partial');

});

$('a[href="#released-bom"]').one('click', function () {

    $('#released-bom').load('/bom-produksi/bom/released-partial');
