...
@section('content')
            ...
            <div class="monitor-wrapper">
                ...
                <div class="panel">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn-light btn-sm shadow-sm" id="btn-detail" style="display:none;color:black">
                                ...
                                <tbody id="detail-list">
                                    ...
                                    @foreach ($inspection as $inspected)
                                        <tr class="inspection-row"
                                            ...
                                            <td>{{ $inspected->detailPo->detail['description'] ?? '-' }}</td>

                                            <td>{{ optional($inspected->po)->company_name ?? '-' }}</td>
                                            <td>{{ optional($inspected->spk)->data['no_spk'] ?? '-' }} <br>
                                                {{ optional($inspected->spk)->data['sup'] ?? '-' }}
                                            </td>
    ...
    `);
            ...
            <script>
                ...
                $(document).on('click', '.inspection-row', function() {
            ...
            <style>
                ...
                .header-controls {
                    ...
                    align-items: center;
                    gap: 12px;
                    /* Jarak antara kolom search dan date */
                }
