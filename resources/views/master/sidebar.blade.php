     ...
     <div class="left navside dark dk" data-layout="column">
         <div class="navbar no-radius">
             ...
             <a class="navbar-brand">
                 <img style="height:80%; max-height:60px;" src="{{asset('/assets/images/NEWWICKER WHITE.png')}}" class="">
                 ...
                 <ul class="nav" ui-nav>
                     ...
                     <li>
                         ...
                         <ul class="nav-sub">
                             <li>
                                 <a href="/marketing">
                                     <span class="nav-text">PFI</span>
                                 </a>
                             </li>
                             <li>
                                 <a href="/marketing/buyers_list">
                                     <span class="nav-text">Buyyers list</span>
                                 </a>
                             </li>
                             <li>
                                 <a href="contact.html">
                                     <span class="nav-text">Realese PFI</span>
                                 </a>
                             </li>
                     ...
                     <!-- <li>
                         ...
                         <ul class="nav-sub">
                             ...
                             <li>
                                 <a href="asides.html">
                                     <span class="nav-text">Progress Produksi</span>
                                 </a>
                             </li>
                             <li>
                                 <a href="footers.html">
